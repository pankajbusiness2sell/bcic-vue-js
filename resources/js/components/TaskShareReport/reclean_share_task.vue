                       ...
                       <div class="card-header">
                               <div class="d-flex justify-content-between">
                                   <div class="pt-2">
                                       ...
                                       <h5 class="card-title text-nowrap">Re-Clean Task Report</h5>
                                   </div>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td>{{ taskdata.quote_id }} {{ taskdata.id }}</td>
                        <td>{{ taskdata.name }}</td>
                        <td>{{ taskdata.email }}</td>
                        <td>{{ taskdata.phone }}</td>
                        <td> {{ taskdata.reclean_status }}</td>
        ...
        setup() {
            ...
            const getadminlist = async () => {
                try {
                    ...
                    response.push({'id':0, 'name':'Not Assign','login_status':0});
            ...
            const getsalesTask = async () => {
                loading.value = true;
                try {
                    const formData = {adminid: 'all', taskType: 6};
            ...
            const quoteassign = async (event, typeid) => {
                ...
                const confirmMessage = `Do you want to move Reclean tasks to ${showtext}?`;
                ...
                const response = await sendData('post', '/reclean-track-task-assign', formData);
