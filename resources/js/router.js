...
import NotFound from './components/NotFound.vue'; // Import NotFound component

const routes = [
  { path: '/', name: 'create-quote', component: QuotePage },
  { path: '/create-quote', name: 'create-quote', component: QuotePage },
  { path: '/view-quote', name: 'view-quote', component: ViewQuote },
  { path: '/track-list-view', name: 'ListviewQuote', component: ListviewQuote },
  { path: '/track-board-view', name: 'track-board-view', component: BoardviewQuote },
  { path: '/bcic-email', name: 'bcic-email', component: EmailsPages },
  {
    path: '/jobpopup',
    name: 'JobPopupnew',
  ...
  },
  {
    ...
    props: route => ({ tab: Number(route.query.tab) || 1 }),
  },
  { path: '/task-share-report', name: 'task-share-report', component: Taskreports },
  { path: '/job-un-assigned', name: 'job-un-assigned', component: Unassigned },
  { path: '/dispatch-report', name: 'dispatch-report', component: DispatchReport },
  { path: '/gps-location', name: 'gps-location', component: GpsLocation },
  { path: '/:pathMatch(.*)*', component: NotFound }, // Use NotFound component for 404
];
