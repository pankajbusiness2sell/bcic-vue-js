                       ...
                       <div class="card-header">
                               <div class="d-flex justify-content-between">
                                   <div class="pt-2">
                                       ...
                                       <h5 class="card-title text-nowrap">Custome Task Report</h5>
                                   </div>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td>{{ taskdata.heading }}</td>
                            <td>{{ taskdata.comment }}</td>
                            <td>{{ getadminname(taskdata.task_from) || 'Auto' }}</td>
                            <td>{{ taskdata.login_id }}</td>
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const getsalesTask = async () => {
                loading.value = true;
                try {
                    const formData = {adminid: 'all', taskType: 5};
            ...
            const quoteassign = async (event, typeid) => {
                ...
                const response = await sendData('post', '/custome-track-task-assign', formData);
