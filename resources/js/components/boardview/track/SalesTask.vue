<template>
    ...
    <div class="d-flex justify-content-between mt-1" >
        ...
        <ul class="kanban-items-right">
            ...
            <li class="kanban-icon me-2">
              <select name="step" class="form-select" v-model="trackData.step">
                  <option value="0">Select</option>
                  <option :value="sKey" v-for="(svalue, sKey) in trackData.status" :key="sKey" >{{ svalue  }}</option>
              </select>
            </li>
        </ul>
    </div>
