<template>
    ...
    <div class="d-flex justify-content-between mt-1" >
        <ul>
            <li class="kanban-icon kanban-user" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Christopher (#Q215981)" > <i class="ti ti-user-circle"></i> {{ 'Q#'+trackData.quote_id }} <a href="#0">(#{{ 'J#'+trackData.job_id }})</a></li>
            <li class="kanban-icon kanban-email" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="cjh89@outlook.com.au"><i class="ti ti-mail"></i> {{ trackData.email }}</li>
            <li class="kanban-icon kanban-phone" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="XXXX-7327"><i class="ti ti-phone-call"></i> <a href="#0">{{ trackData.phone }}</a></li>
            <li class="kanban-icon kanban-phone" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="XXXX-7327"><i class="ti ti-location-pin"></i> <a href="#0">{{ trackData.site_name }}</a></li>
        ...
        <ul class="kanban-items-right">
            ...
            <li class="kanban-icon kanban-date text-nowrap">
              <select name="step" class="form-select" v-model="trackData.message_status" @change="statusUpdate($event, trackData.id, 'J#'+trackData.job_id)">
