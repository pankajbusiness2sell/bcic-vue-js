                       ...
                       <div class="card-header">
                               <div class="d-flex justify-content-between">
                                   <div class="pt-2">
                                       ...
                                       <h5 class="card-title text-nowrap">Complaint Task Report</h5>
                                   </div>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td>{{ taskdata.statusdd?.[taskdata.message_status] || '' }}</td>
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const getsalesTask = async () => {
                loading.value = true;
                try {
                    const formData = {adminid: 'all', taskType: 12};
            ...
            const quoteassign = async (event, typeid) => {
                ...
                const response = await sendData('post', '/complaint-track-task-assign', formData);
