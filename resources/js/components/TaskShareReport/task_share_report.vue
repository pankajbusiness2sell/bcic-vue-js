                       ...
                       <div class="card-header">
                               <div class="d-flex justify-content-between">
                                   <div class="pt-2">
                                       ...
                                       <h5 class="card-title text-nowrap">Sales Task Report</h5>
                                   </div>
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const getsalesTask = async () => {
                loading.value = true;
                try {
                    const formData = {adminid: 'all', taskType: 1};
            ...
            const quoteassign = async (event, typeid) => {
                ...
                const response = await sendData('post', '/track-task-assign', formData);

                if (response.success === true) {

                    checkedItems.value = [];

                    // const movedRecords = propsData.value.allRecords.filter(record =>
                    //         formData.chekcedid.includes(record.id)
                    //     );
                    ...
                    const OtheradminRecords = getTrackData.value.getrecords[adminid];
